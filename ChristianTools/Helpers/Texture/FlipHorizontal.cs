...
namespace ChristianTools.Helpers
{
    public partial class Texture
    {
        public static Texture2D FlipHorizontal(Texture2D originalTexture)
        {
            ...
            Color[,] original_MultidimentionalColors = ChristianTools.Helpers.Other.ToMultidimentional<Color>(original_Colors, originalTexture.Width, originalTexture.Height);
            ...
            {
                Color[] original_RowColors = ChristianTools.Helpers.Other.GetRow(original_MultidimentionalColors, row);
            ...
            Color[] result_Colors = Helpers.Other.FlattenArray<Color>(result_MultidimentionalColors);
