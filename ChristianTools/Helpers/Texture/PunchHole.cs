        ...
        public static Texture2D PunchHole(Texture2D bigTexture, Point[] points, int gradientLength = 20, int fullBrightDistance = 10)
        {
            // === Implementation ===
            {
                ...
                Color[,] bigTexture_Color;
                {
                    ...
                    bigTexture_Color = ChristianTools.Helpers.Other.ToMultidimentional(colors, bigTexture.Width, bigTexture.Height);
                }
                ...
                result_flatColors = ChristianTools.Helpers.Other.FlattenArray<Color>(bigTexture_Color);
