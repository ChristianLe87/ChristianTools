	...
	public class Scene_UI : IScene
	{
		...
		public void Initialize(Viewport viewport)
		{
			...
			this.UIs = new List<IUI>()
            {
                ...
                // Left
                new Label(new Rectangle(10, 10, 100, 30),  "My Text", textAlignment: Label.TextAlignment.Top_Left,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(10, 50, 100, 30), "My Text", Label.TextAlignment.Midle_Left,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(10, 90, 100, 30), "My Text", Label.TextAlignment.Down_Left,MyColors.CreateColorTexture(Color.LightGray)),

                // Center
                new Label(new Rectangle(120, 10, 100, 30), "My Text", Label.TextAlignment.Top_Center,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(120, 50, 100, 30), "My Text", Label.TextAlignment.Midle_Center,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(120, 90, 100, 30), "My Text", Label.TextAlignment.Down_Center,MyColors.CreateColorTexture(Color.LightGray)),

                // Right
                new Label(new Rectangle(230, 10, 100, 30),"My Text", Label.TextAlignment.Top_Right,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(230, 50, 100, 30),  "My Text", Label.TextAlignment.Midle_Right,MyColors.CreateColorTexture(Color.LightGray)),
                new Label(new Rectangle(230, 90, 100, 30),  "My Text", Label.TextAlignment.Down_Right,MyColors.CreateColorTexture(Color.LightGray)),
